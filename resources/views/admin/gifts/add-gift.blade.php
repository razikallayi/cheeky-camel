...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/gift')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" maxlength="60" value="{{old('title')}}" name="title" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label>Add Image : <span>[Note: Use Images With Transparent Background] </span></label>
							...
							<div id="result" class="img-preview preview-lg row">
								...
								<img class="img-responsive" src="{{url(App\Models\Gift::IMAGE_LOCATION)."/".$imageName}}" height="150" ></span></div>
								@endforeach
								@endif
							</div> 
						</div>
...
{{-- 				<button type="button" id="close-models" onclick="closeModels();" class="btn btn-lg btn-success" data-dismiss="modal">Close</button> --}}
			</div>
		</div>
	</div>
</div>
