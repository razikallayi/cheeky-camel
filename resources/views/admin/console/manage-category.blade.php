...
@section('title','Console | Category')
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				@endif
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="{{url('admin/category/edit/'.$cats->id)}}"><i class="material-icons">edit</i></a></td>
							<td width="5px"><a href="{{url('admin/category/'.$cats->id)}}" onclick="event.preventDefault();
								document.getElementById('delete-form-{{$cats->id}}').submit();">
								<form id="delete-form-{{$cats->id}}" action="{{ url('admin/category/'. $cats->id) }}" method="post" style="display: none;">
									{{ csrf_field() }}
									{{ method_field('DELETE') }}
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
			<div class="card">
				<div class="body">
					No data to display.
					<a href="{{url('admin/console/add-category')}}" class="btn btn-info pull-right">Add Category</a>
				</div>
			</div>
		</div>
		@endif
