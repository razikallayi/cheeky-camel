...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/shop')}}" enctype="multipart/form-data">
				{{csrf_field()}}
				...
				<input type="checkbox" name="newitem" id="md_checkbox_30"  class="filled-in chk-col-pink" value="1" />
...
// 	$("#mnu-top").addClass('active').find('a').click();
// });
</script>
