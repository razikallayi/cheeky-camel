...
@section('title','TableTop | Edit')

@section('active_menu','mnu-top')
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/shop/'.$shops->id)}}" enctype="multipart/form-data">
				{{csrf_field()}}
				{{method_field('PUT')}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" maxlength="60"  name="productname" class="form-control" value="{{$shops->title}}" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group">
							<div class="form-line">
								<textarea id="" name="description"  maxlength="50000" class="form-control" required>{{$shops->description}}</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" min="0" max="100000" value="{{$shops->quantity}}" name="quantity" class="form-control" required >
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" min="1" max="100000"  value="{{$shops->price}}" name="price" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" value="{{$shops->discount}}" min="0" max="100"  name="discount" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$shops->theme}}" name="theme" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$shops->mechanic}}" name="mechanic" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number"  min="0" max="100" value="{{$shops->minimum_age}}" name="minage" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number"  min="0" max="100" value="{{$shops->minimum_players}}" name="players" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text"  min="0" max="100" value="{{$shops->playing_time}}" name="time" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$shops->publisher}}" name="publisher" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<input type="checkbox" name="newitem" id="md_checkbox_30"  class="filled-in chk-col-pink" value="{{$shops->new_product}}" {{ $shops->new_product=="1"?"checked":"" }}/>
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div id="result" class="img-preview preview-lg row">
								@foreach($shops->images as $shop)

								<div id="image-preview-{{substr($shop->images,0,-4)}}" class="col-md-3" style="min-height:240px"><span><button type="button" onclick="deleteImage('{{$shop->images}}')" class="btn btn-xs  waves-effect btn-danger pull-right"><i class="material-icons">close</i></button><img class="img-responsive" src="{{url(App\Models\ShopImage::IMAGE_LOCATION)."/".$shop->images}}"></span></div>
								@endforeach							
...
<script>
	$(function() {
    	...
    	$('#CropperModal').on('shown.bs.modal', function() {
    		...
    		var location= "{{App\Models\ShopImage::IMAGE_LOCATION}}";
    		$.ajax({
    			url : "{{url('admin/shop/upload-image')}}", 
    			type: "POST",
    			data:  {
	...
	var deleteImage = function(filename){
		$.ajax({
			...
			type: 'DELETE',
			data:{location:"{{App\Models\ShopImage::IMAGE_LOCATION}}",
			filename:filename
		},
		success: function(){
