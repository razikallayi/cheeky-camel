...
@section('title','Apparels | Edit')

@section('active_menu','mnu-hj')
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/apparels/'.$items->id)}}" enctype="multipart/form-data">
				{{csrf_field()}}
				{{method_field('PUT')}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" maxlength="60"  name="itemname" class="form-control" value="{{$items->title}}" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group">
							<div class="form-line">
								<textarea id="" name="description"  maxlength="50000" class="form-control" required>{{$items->description}}</textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" min="0" max="100000"  value="{{$items->quantity}}" name="quantity" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" min="1" max="100000"  value="{{$items->price}}" name="price" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number" value="{{$items->discount}}" min="0" max="100"  name="discount" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$items->theme}}" name="theme" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$items->mechanic}}" name="mechanic" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number"  min="0" max="100" value="{{$items->minimum_age}}" name="minage" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="number"  min="0" max="100" value="{{$items->minimum_players}}" name="players" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text"  min="0" max="100" value="{{$items->playing_time}}" name="time" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="text" value="{{$items->publisher}}" name="publisher" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
				...
				<input type="hidden" name="newitem" id="md_checkbox_30"  class="filled-in chk-col-pink" value="{{$items->new_product}}" {{($items->new_product == "1")?"checked" : ""}} />
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div id="result" class="img-preview preview-lg row">
								...
								<div id="image-preview-{{substr($item->images,0,-4)}}" class="col-md-3" style="min-height:240px"><span><button type="button" onclick="deleteImage('{{$item->images}}')" class="btn btn-xs  waves-effect btn-danger pull-right"><i class="material-icons">close</i></button><img class="img-responsive" src="{{url(App\Models\Apparel_image::IMAGE_LOCATION)."/".$item->images}}"></span></div>
								@endforeach							
